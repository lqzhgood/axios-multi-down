...
function x(t, n = p) {
  return t.down = async function(e, r, a) {
    ...
    const o = N(u), l = await j(t, o, s);
    if (l) {
      const i = A(l, o.blockSize);
      o.max = o.max <= i.length ? o.max : i.length;
      let h;
      return o.max === 1 ? h = await E(t, s, o) : h = await v(t, s, o, i, l), h;
    } else
...
async function j(t, n, e) {
  ...
  let u = null;
  return r === f.HEAD || k === w.Browser ? u = await L(t, s) : u = await T(t, s), u;
}
function L(t, n) {
  return new Promise((e) => {
    t({ ...n, method: f.HEAD }).then((r) => {
      const a = r.headers["content-range"];
      r.headers["content-length"] == 1 && a ? e(Number(a.split("/")[1])) : e(null);
    }).catch(() => {
      e(null);
    });
  });
...
async function E(t, n, e) {
  var o, l;
  const r = await t(n), a = { s: 0, e: r.headers["content-length"] - 1, i: 0, resp: r };
  return (o = e.emitter) == null || o.emit("data", a), (l = e.emitter) == null || l.emit("end"), { ...r, isMulti: !1, downConfig: e, queue: [a] };
}
function v(t, n, e, r, a) {
  return new Promise((s, u) => {
    let o;
    const l = n.responseType || "json";
    let i = 0, h = 0;
    const m = r.map((d) => () => new Promise((D, R) => {
      i++, h++;
      const S = {
      ...
      t({ ...n, headers: S, responseType: "arraybuffer" }).then((c) => {
        var y, b;
        if (c.data = c.data instanceof ArrayBuffer ? new Uint8Array(c.data) : c.data, d.resp = c, (y = e.emitter) == null || y.emit("data", d), o || (o = {
          ...c,
          isMulti: !0,
          downConfig: e,
          queue: r
          ...
          switch ((b = e.emitter) == null || b.emit("end"), c.data = M(
            ...
            case "json":
              try {
                c.data = new TextDecoder("utf-8").decode(c.data), c.data = JSON.parse(c.data), c.config.responseType = l;
              } catch {
              }
              break;
            case "text":
              c.data = new TextDecoder("utf-8").decode(c.data), c.config.responseType = l;
          }
          o = {
            ...c,
            isMulti: !0,
        ...
        h--, i < m.length && (h < e.max || e.max === 1) && m[i]();
      });
    }));
